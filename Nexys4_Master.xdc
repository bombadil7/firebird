...
set_property PACKAGE_PIN T8 [get_ports {rightlight[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rightlight[0]}]
#Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports {rightlight[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rightlight[1]}]
#Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
set_property PACKAGE_PIN R8 [get_ports {rightlight[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rightlight[2]}]
...
set_property PACKAGE_PIN U1 [get_ports {leftlight[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leftlight[0]}]
#Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
set_property PACKAGE_PIN R2 [get_ports {leftlight[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leftlight[1]}]
#Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
set_property PACKAGE_PIN P2 [get_ports {leftlight[2]}]					
...
set_property PACKAGE_PIN T16 [get_ports lsig]						
	set_property IOSTANDARD LVCMOS33 [get_ports lsig]
#Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
set_property PACKAGE_PIN R10 [get_ports rsig]						
	set_property IOSTANDARD LVCMOS33 [get_ports rsig]
